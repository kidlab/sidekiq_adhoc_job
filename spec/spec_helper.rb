...
RSpec.configure do |config|
  ...
  config.before do
    ...
    redis.define_singleton_method(:config) { OpenStruct.new(server_url: 'redis://localhost:6379') }
    ...
    allow(redis).to receive(:sscan) { |key| redis.common_scan(redis.smembers(key), 0)[1] }
